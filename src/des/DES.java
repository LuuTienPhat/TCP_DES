...
public class DES {
    ...
    static int IP1[] = {40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47, 15, 55, 23, 63, 31, 38, 6, 46, 14, 54, 22, 62, 30, 37, 5, 45, 13, 53, 21, 61, 29, 36, 4, 44, 12, 52, 20, 60, 28, 35, 3, 43, 11, 51, 19, 59, 27, 34, 2, 42, 10, 50, 18, 58, 26, 33, 1, 41, 9, 49, 17, 57, 25};
...
//            System.out.printf("ER02 = %#X\n", ER02);
    ...
    public static String intToHex(int C, int radix) {
        String format = "%0" + radix + "x";
...
//        System.out.println("");
        ...
        return intToHex(C1, 8) + "" + intToHex(C2, 8);
    }
...
//        int M2 = 0x89ABCDEF;
        ...
        //ShowByte(C2);
        //System.out.println("");
        return hexToText(intToHex(C1, 8)) + hexToText(intToHex(C2, 8));
    }
...
// Hex To Text
    ...
    public static List<Integer> getHexIntAray(String text) {
        ...
        for (int i = 0; i < M.length(); i += 8) {
            ...
            array.add(Integer.parseUnsignedInt(cut, 16));
        }
        return array;
    }
    ...
    public static String encrypt(String text, String key) {
        ...
        String K = textToHex(key);
        int K1 = Integer.parseUnsignedInt(K.substring(1, 8));
    ...
    public static String decrypt(String text, String key) {
        ...
        for (int i = 0; i < array.size() - 1; i += 2) {
            plainText += giaiMaDES(array.get(i), array.get(i + 1), K1, K2, MC1, MC2);
        }
        return plainText;
    }

    public static void main(String[] args) {
        String text = "Xin chao cac ban chuc mot ngay tot lanh";
        String key = "12345678";
